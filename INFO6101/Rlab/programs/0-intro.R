...
## Session - Set Worki?g Directory - Choose Directory...
...
## "R is a free software environment for statisti?al computing and graphics"
...
## 2. graphics, including package `ggplot2`?## 3. basic statistical models: linear and logistic regression
...
## Q? ?nything specific you'd like to know about R?
